...
public class ChatController {
    ...
    @GetMapping
    public ResponseEntity<List<Conversation>> getConversations(@RequestHeader(value = "UserId", defaultValue = "user_1") String userId) {
    ...
    public ResponseEntity<ChatMessageDto> sendMessage(
            ...
            @RequestHeader(value = "UserId", defaultValue = "user_1") String senderId) {

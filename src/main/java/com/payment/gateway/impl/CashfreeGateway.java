...
/**
 * Cashfree Gateway Integration (Stub / Placeholder).
...
public class CashfreeGateway implements PaymentGateway {
    ...
    public GatewayOrderResponse createOrder(GatewayOrderRequest request) {
        throw new PaymentGatewayException("Cashfree payment gateway integration is currently in preview/stub mode. Please use RAZORPAY.");
    }

    @Override
    public boolean verifySignature(String orderId, String paymentId, String signature) {
        throw new PaymentGatewayException("Cashfree signature verification stub.");
    }

    @Override
    public GatewayRefundResponse processRefund(GatewayRefundRequest request) {
        throw new PaymentGatewayException("Cashfree refund stub.");
    }
}

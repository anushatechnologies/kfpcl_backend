...
public class ChatMessageDto {
    ...
    public ChatMessageDto(Long id, Long conversationId, String senderId, String receiverId, String content, LocalDateTime timestamp) {
        this.id = id;
    ...
    public static class ChatMessageDtoBuilder {
        ...
        public ChatMessageDtoBuilder conversationId(Long conversationId) { this.conversationId = conversationId; return this; }
